...
public class HideAnim {
     ...
     */
    public static HideAnim newInstance(Context context,View hideView,View down,int height){
        return new HideAnim(context,hideView,down,height);
    }

    private HideAnim(Context context,View hideView,View down,int height){
