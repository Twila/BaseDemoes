 ...
 */
public class ArcSeekBarOrigin extends View {
    ...
    public ArcSeekBarOrigin(Context context) {
        this(context,null);
    }

    public ArcSeekBarOrigin(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ArcSeekBarOrigin(Context context, AttributeSet attrs, int defStyleAttr) {
